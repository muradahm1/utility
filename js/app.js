...
function initSearchModal() {
    ...
    const SYNONYMS = {
        ...
        'true-home-buying-cost-calculator': ['true cost of buying a house', 'home closing costs', 'mortgage break even'],
        ...
        'freelance-true-hourly-rate-calculator': ['freelance true hourly rate', 'freelance rate calculator after taxes'],
